...
<div class="body-inner">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="dropdown-submenu"><a href="#">Page Title</a>
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a href="page-title-background-color.html">Colored background</a>
                                                </li>
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="dropdown-submenu"><a href="#">Sliders</a>
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a href="slider-static-media-parallax.html">Fullscreen Parallax</a>
                                                </li>
                                                <li><a href="slider-static-media-text-rotator.html">Fullscreen Text
                                                        Rotator</a></li>
                                                <li><a href="slider-static-media-video.html">Fullscreen HTML5 Video</a>
                                                </li>
                                            </ul>
                                        </li>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-2">
                                                    <ul>
                                                        ...
                                                        <li><a href="shortcode-form-validation.html">Form Validation</a>
                                                        </li>
                                                        ...
                                                        <li><a href="shortcode-heading-styles.html">Heading Styles</a>
                                                        </li>
                                                ...
                                                <div class="col-lg-2">
                                                    <ul>
                                                        ...
                                                        <li><a href="shortcode-labels-badgets.html">Labels & Badges</a>
                                                        </li>
                                                        ...
                                                        <li><a href="shortcode-paginations.html">Pagination & Pager</a>
                                                        </li>
                                                ...
                                                <div class="col-lg-2">
                                                    <ul>
                                                        <li><a href="shortcode-pricing-table.html">Pricing tables</a>
                                                        </li>
                                                        ...
                                                        <li><a href="shortcode-responsive-utilities.html">Responsive
                                                                utilities</a></li>
                                                        <li><a href="component-ion-range-slider.html">Range Slider<span
                                                                    class="badge badge-danger">NEW</span></a></li>
                                                        ...
                                                        <li><a href="component-toggles-radio-checkboxes.html">Switch
                                                                Toggle<span class="badge badge-danger">NEW</span></a>
                                                        </li>
                                                        <li><a href="shortcode-shape-dividers.html">Shape Dividers<span
                                                                    class="badge badge-danger">NEW</span></a></li>
                                                    </ul>
                                                </div>
                                                <div class="col-lg-2">
                                ...
                                <li class="dropdown"><a href="#">Pages</a>
                                    <ul class="dropdown-menu">
                                        <li class="dropdown-submenu"><span
                                                class="dropdown-menu-title-only">About us</span>
                                            <ul class="dropdown-menu">
                                        ...
                                        <li class="dropdown-submenu"><span
                                                class="dropdown-menu-title-only">About me</span>
                                            <ul class="dropdown-menu">
                                        ...
                                        <li class="dropdown-submenu"><span
                                                class="dropdown-menu-title-only">Contact us</span>
                                            <ul class="dropdown-menu">
                                        ...
                                        <li class="dropdown-submenu"><span
                                                class="dropdown-menu-title-only">User pages</span>
                                            <ul class="dropdown-menu">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-2-5">
                                                    <ul>
                                                        ...
                                                        <li><a href="portfolio-masonry-sidebar.html">Sidebar version</a>
                                                        </li>
                                                ...
                                                <div class="col-lg-2-5">
                                                    <ul>
                                                        ...
                                                        <li><a href="portfolio-load-more-sidebar.html">Load more -
                                                                Sidebar</a></li>
                                                        <li><a href="portfolio-infinite-scroll.html">Infinity Scroll</a>
                                                        </li>
                                                ...
                                                <div class="col-lg-2-5">
                                                    <ul>
                                                        ...
                                                        <li><a href="portfolio-no-page-title-sidebar.html">No Page Title
                                                                - Sidebar</a></li>
                                                ...
                                                <div class="col-lg-2-5">
                                                    <ul>
                                                        ...
                                                        <li><a href="portfolio-page-grid-gallery.html">Grid Gallery</a>
                                                        </li>
                                                                ...
                                                                <div class="col-lg-9 m-t-10">
                                                                    <div class="text-center center">
                                                                        <div class="heading-creative">
                                                                            <strong>20+</strong> Amazing Hover Styles
                                                                        </div>
                                                                    </div>
                                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-2-5">
                                                    <ul>
                                                        ...
                                                        <li><a href="blog-masonry-no-page-title.html">No page title</a>
                                                        </li>
                                                ...
                                                <div class="col-lg-2-5">
                                                    <ul>
                                                        ...
                                                        <li><a href="blog-left-image-sidebar-right.html">Right
                                                                Sidebar</a></li>
                                                        <li><a href="blog-left-image-sidebar-left.html">Left Sidebar</a>
                                                        </li>
                                                        ...
                                                        <li><a href="blog-left-image-infinite-scroll.html">Infinite
                                                                Scroll</a></li>
                                                        <li><a href="blog-left-image-author-info.html">Author Info</a>
                                                        </li>
                                                        <li><a href="blog-left-image-filter.html">Filter Categories</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div class="col-lg-2-5">
                                                ...
                                                <div class="col-lg-2-5">
                                                    <ul>
                                                        ...
                                                        <li><a href="blog-comments.html#comments">Default Comments</a>
                                                        </li>
                                        ...
                                        <li class="mega-menu-content">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-2-5">
                                                    <ul>
                                                        ...
                                                        <li><a href="shop-load-more.html">Load more</a><a
                                                                href="shop-load-more-sidebar.html">Load Sidebar</a></li>
                                                ...
                                                <div class="col-lg-2-5">
                                                    <ul>
                                                        ...
                                                        <li><a class="animsition-link" href="shop-cart-empty.html">Shoping
                                                                Cart - Empty</a></li>
                                                        <li><a class="animsition-link" href="shop-checkout.html">Checkout</a>
                                                        </li>
                                                ...
                                                <div class="col-lg-2-5 p-l-0">
                                                    ...
                                                    <p class="m-b-0">The most happiest time of the day!. Morbi sagittis,
                                                        sem quis ipsum dolor sit amet lacinia faucibus.</p><a
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <h2 class="text-medium m-t-0">Добро пожаловать на сайт знакомств</h2>
                    <div class="seperator"></div>
                    <p class="lead">Ищите серьезные отношения, любовь или интим? Хотите познакомиться онлайн с интересными людьми? Тогда наш бесплатный сайт знакомств в Минске сэкономит время на поиски нужных контактов.

                        Организуемые нами знакомства в интернете начинаются с регистрации на сайте или авторизации через одну из соцсетей. Далее следует бесплатный тест на совместимость, чтобы ускорить поиск второй половинки или новых друзей.</p>
                </div>
                <div class="col-lg-7">
            ...
            <div class="footer-content p-t-10">
                <div class="container">
                    <div class="row text-center">
                        ...
                        <div class="copyright-text text-center"> &copy; 2016 POLO - Best HTML5 Template Ever. All Rights
                            Reserved. <a target="_blank" href="//www.inspiro-media.com">INSPIRO</a>
                        </div>
