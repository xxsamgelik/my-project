    ...
    <section class="profile-content">
        ...
        <div class="profile-bio">
            ...
            <p>
                ...
                Мы - команда профессионалов, которые страстно желают помочь людям найти значимые связи и построить долгосрочные отношения. Наша миссия заключается в создании безопасной и гостеприимной среды, где одинокие люди могут встречаться, общаться и узнавать друг друга без какого-либо давления или осуждения.
                Мы считаем, что знакомства в Интернете должны быть веселыми, легкими и доступными для всех. Именно поэтому мы разработали нашу платформу удобной, интуитивно понятной и оснащенной инновационными функциями, которые облегчают поиск идеальной пары.
                Наша команда состоит из опытных разработчиков, дизайнеров и специалистов по поддержке клиентов, которые неустанно работают над тем, чтобы ваши знакомства в Интернете были плавными и приятными. Мы всегда прислушиваемся к вашим отзывам и предложениям, чтобы улучшить наши услуги и сделать ваш опыт еще лучше.
                На нашем сайте знакомств мы ценим вашу конфиденциальность и безопасность. Мы используем новейшие технологии шифрования и передовые протоколы безопасности для защиты вашей личной информации и обеспечения безопасного и надежного знакомства в Интернете.
                Спасибо, что выбрали наш сайт знакомств. Мы надеемся, что вы найдете то, что ищете, и желаем вам всего наилучшего в ваших поисках любви и общения!
            </p>
            <div class="m-t-60">
